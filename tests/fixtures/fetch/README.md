...
Generated by the artifact producer's fixture generator (`just fetch-fixtures`
produces this set there; `just fetch-fixtures-check` proves it is byte-identical
to a fresh generation). The generator hands a fake artifact cache to `dist/publish.sh
