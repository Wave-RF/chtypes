/**
 * The fetch/verify/install contract (docs/guides/fetch.md), tested offline.
 *
...
describe('the signature (docs/guides/fetch.md §4)', () => {
...
describe('the verification chain against a synthetic release (docs/guides/fetch.md §3)', () => {
...
describe('the CLI (docs/guides/fetch.md §6)', () => {
  const good = makeRelease({ artifacts: [{ minor: '25.8', version: '25.8.28.1-lts' }, { minor: '26.7', version: '26.7.3.19-stable' }] });
...
if (!HAVE_FIXTURES) {
  console.warn(`\n[chtypes] tests/fixtures/fetch is ABSENT (${SPEC_FIXTURES}): the shared fetch vectors (docs/guides/fetch.md §9) are SKIPPED.\n`);
}
