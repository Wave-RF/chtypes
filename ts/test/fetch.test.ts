 ...
 *  - the shared vectors under `tests/fixtures/fetch/` (§9), generated by the
...
if (!HAVE_FIXTURES) {
  console.warn(`\n[chtypes] tests/fixtures/fetch is ABSENT (${SPEC_FIXTURES}): the shared fetch vectors (docs/fetch.md §9) are SKIPPED.\n`);
}
...
describe.skipIf(!HAVE_FIXTURES)('the shared vectors under tests/fixtures/fetch (docs/fetch.md §9)', () => {
  let key: string;
