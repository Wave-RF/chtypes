...
/**
 * The codes docs/fetch.md §6 shares across every SDK, as named constants.
 *
...
/** docs/fetch.md §6: the signature did not verify against the trust list. */
export const CODE_ARTIFACT_UNTRUSTED = 'CHTYPES_ARTIFACT_UNTRUSTED';
/** docs/fetch.md §6: a hash mismatch, or a release that disagrees with itself. */
export const CODE_ARTIFACT_CORRUPT = 'CHTYPES_ARTIFACT_CORRUPT';
/** docs/fetch.md §6: `--frozen` refused an asset the lock file does not pin. */
export const CODE_ARTIFACT_PINNED = 'CHTYPES_ARTIFACT_PINNED';
/** docs/fetch.md §6: the release offers nothing for this platform or line. */
export const CODE_ARTIFACT_UNPUBLISHED = 'CHTYPES_ARTIFACT_UNPUBLISHED';
/** docs/fetch.md §6: the source could not be reached or does not serve the release. */
