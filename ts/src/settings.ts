 ...
 *
 * This is not cosmetic (the C ABI contract §Settings): `chtypes_now_epoch_nanos` is a
 ...
 * (clock control and admission budgets — the C ABI contract §Settings), by name.
 *
