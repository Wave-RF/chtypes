...
| ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| `Registry::from_search_path()` / `from_search_path_with(RegistryOptions)`                                     | loads nothing until asked                                              | optional explicit dir, timezone, `autofetch`, `verify_checksums` (+ `fetch: EnsureOptions`) | `Registry` — lazy, one line per open                                                                | `ChecksumMismatch` with `verify_checksums`; otherwise as the row below, per line as it opens                                            |
