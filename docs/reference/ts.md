...
| `Library#quoteIdentifier(name)` / `#quoteIdentifierIfNeeded(name)` / `#quoteLiteral(text)` | the three quoting functions                                  | the spelling ClickHouse itself prints             | `UnsupportedError`; `SchemaError` (a guarded exception's code)                                                                                                                                                    |
