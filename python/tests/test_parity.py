...
# Names the manifest carries that `docs/reference/bindings.md` is not expected to spell.
...
def test_the_manifest_and_the_spec_table_agree() -> None:
    ...
    `docs/reference/bindings.md` is prose for humans and the manifest is data for machines.
